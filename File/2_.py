...
with open("MOCK_DATA.csv", "r") as csvfile: #with untuk streaming file, secara otomatis akan close bersihin file saat ga di pake lagi
...
for x in array[:5]: #membatasi cuma membaca 5 data
    ...
    print(x["first_name"] + " - " + x["email"]) #dalam dictionary
